...
public class AVLBinarySearchTree<Type extends Comparable<? super Type>>
{
    ...
    /**
     * Adds all items from a given collection into the tree.
     * 
     * @param items collection of elements to be added
     * @return true if all the elements from the collection were added, otherwise returns false
     */
    ...
    /**
     * Returns true if the tree contains every item from the specified set, otherwise returns false.
     * 
     * @param items collection of elements to be checked
     * @return true if all the elements from the collection were present, otherwise returns false
     */
    public boolean containsAll (Collection<? extends Type> items)
    {
        if (size(root) != items.size())
            return false;
    ...
    {
        if (node == null)
            throw new NoSuchElementException("The given item does not exist");            
        else if (item.compareTo(node.element) < 0)
    ...
    /**
     * Recursive helper method that adds all the nodes to an ArrayList using in-order traversal.
     */
    ...
    /**
     * Rotates the given subtree of the node one place left
     * 
     * @param node the subtree
     * @return the node that is the new root of the subtree
     */
    ...
    /**
     * Rotates the given subtree of the node one place right
     * 
     * @param node the subtree
     * @return the node that is the new root of the subtree
     */
